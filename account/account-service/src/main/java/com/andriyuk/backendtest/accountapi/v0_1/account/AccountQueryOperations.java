...
import static com.andriyuk.backendtest.accountapi.v0_1.account.AccountQueryOperations.ACCOUNTS_RESOURCES_PATH;

/**
 * Account query operations API
 */
@Validated
@Controller(ACCOUNTS_RESOURCES_PATH)
public interface AccountQueryOperations {
